...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.total = 0
        self.originalx = self.start.clone()
        self.originalz = self.end.clone()
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        return (Line(Point(self.start.x + other_line.start.x, self.start.y + other_line.start.y), Point(self.end.x +
                                                                    other_line.end.x, self.end.y + other_line.end.y)))
    ...
    def is_parallel(self, line2):
        ...
        if (line2.end.x - line2.start.x) == 0:
            ...
            b = (line2.end.y - line2.start.y) / (line2.end.x - line2.start.x)
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.start = self.originalx
        self.end = self.originalz
