...
class Baby(object):
    ...
    def __init__(self, baby_name):
        ...
        self.hours = 0
        print('Hello baby {}'.format(baby_name))

    def feed_baby(self):
        print('Thank you for feeding baby {}'.format(self.babyname))
        self.hours = 0

    def hour_passes(self):
        if self.hours == 0:
            print('Baby {} is sleeping'.format(self.babyname))
        if self.hours == 1:
            print('Baby {} is awake. Time for food'.format(self.babyname))
        if self.hours >= 2:
            print('Baby {} is CRYING uncontrollably! Feed the Baby!'.format(self.babyname))
